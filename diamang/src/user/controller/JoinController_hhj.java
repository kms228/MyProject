...
public class JoinController_hhj extends HttpServlet {
	...
	private void updateOk(HttpServletRequest request, HttpServletResponse response)
		...
		user.vo.MemversVo update = new MemversVo(mnum, id, pwd, name, birthday, email, address, phone, gnum, joindate,grade);
		MembersDao_hhj dao = new MembersDao_hhj();
	...
	private void login(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (n == 1) { // 회원O
			System.out.println(id + "로그인한날자/시간");
			HttpSession session = request.getSession();
	...
	private void insert(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		user.vo.MemversVo user = new MemversVo(0, id, pwd, name, birthday, email, address, phone, null, null,null);
		MembersDao_hhj dao = new MembersDao_hhj();
