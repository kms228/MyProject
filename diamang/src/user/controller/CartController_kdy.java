...
public class CartController_kdy extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(cmd.equals("cartCheck")) {
			...
			if(id==null) {
				...
				//ƒÌ≈∞ √ﬂ∞°
				String item=URLEncoder.encode("≥√¿Â∞Ì","utf-8");
				Cookie cook=new Cookie("item1",item);
				cook.setMaxAge(60*60);//1Ω√∞£
				resp.addCookie(cook);
	...
	private void cartCheck(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
